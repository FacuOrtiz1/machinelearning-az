...
dataset = pd.read_csv("D:/FACU/machinelearning-az/datasets/Part 3 - Classification/Section 16 - Support Vector Machine (SVM)/Social_Network_Ads.csv")
...
classifier = SVC(kernel="rbf",random_state=0) # p = 2 distancia euclidea
