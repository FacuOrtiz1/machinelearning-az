...
dataset = pd.read_csv("D:/FACU/machinelearning-az/datasets/Part 3 - Classification/Section 17 - Kernel SVM/Social_Network_Ads.csv")
...
plt.title('Arbol de clasificación(Conjunto de Entrenamiento)')
plt.xlabel('Edad')
