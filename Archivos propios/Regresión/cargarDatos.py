...
dataset = pd.read_csv('C:/Users/Faaor/OneDrive/Escritorio/Curso ML/machinelearning-az/datasets/Part 1 - Data Preprocessing/Section 2 -------------------- Part 1 - Data Preprocessing --------------------/Data.csv')
